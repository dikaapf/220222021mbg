             ...
             <div class="row footer-help-bar">
                 <div class="col-md-12">
                     ...
                     <?php } else if ($this->ion_auth->is_student()) { ?>
                         ...
                         <a href="<?php if ($this->ion_auth->is_student()) echo URL_STUDENT_POST_REQUIREMENT;
                                    else echo URL_AUTH_LOGIN; ?>" class="btn btn-footer"> <i class="fa fa-pencil"></i> <?php echo get_languageword('Post Your Requirement'); ?></a>
                     <?php } else echo '&nbsp;'; ?>
                         ...
                         <div class="col-sm-5">
                             ...
                             <ul class="footer-links">
                                 ...
                                 <?php if (!$this->ion_auth->logged_in()) { ?>
                                     <li><a href="<?php echo URL_AUTH_DAFTAR; ?>"><?php echo get_languageword('Become a Tutor'); ?></a></li><?php } ?>
