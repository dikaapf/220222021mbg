<div class="panel-group dashboard-menu" id="accordion">
	<div class="dashboard-profile">
		...
		<div class="media media-team">
			<a href="<?php echo base_url(); ?>tutor/index">
				...
				<?php if (!$inst_id) { ?>
					<p><?php echo get_languageword('net_credits'); ?>: <strong>Rp. <?php echo get_user_credits($user_id); ?></strong>
						<!-- Hide kurs poin -->
	...
	<div class="dashboard-menu-panel">
		...
		<?php if (!$inst_id) { ?>
			<div class="panel panel-default">
				...
				<!--/.panel-heading -->
				<div id="collapseOne" class="panel-collapse <?php if (isset($activemenu) && $activemenu == 'enquiries') echo 'collapse in';
															else echo 'collapse'; ?>">
					<div class="panel-body">
						<ul class="dashboard-links">
							...
							<li <?php if (isset($activesubmenu) && $activesubmenu == get_languageword('Tarik_Pendapatan')) echo 'class="active"'; ?>><a href="<?php echo URL_TUTOR_STUDENT_ENQUIRIES; ?>/closed"><?php echo get_languageword('Tarik_Pendapatan'); ?> </a></li>
						</ul>
					</div>
					<!--/.panel-body -->
				</div>
			...
			<div class="panel panel-default">
				...
				<!--/.panel-heading -->
				<div id="collapseManage" class="panel-collapse <?php if (isset($activemenu) && $activemenu == 'manage') echo 'collapse in';
																else echo 'collapse'; ?>">
					<div class="panel-body">
						<ul class="dashboard-links">
	...
	<div class="panel-heading">
		...
		<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSellCourses">
			...
			<!--/.panel-heading -->
			<!-- <div id="collapseSellCourses" class="panel-collapse <?php if (isset($activemenu) && $activemenu == 'sell_courses_online') echo 'collapse in';
																		else echo 'collapse'; ?>">
		<div class="panel-body">
			<ul class="dashboard-links">
			...
			<div class="panel panel-default">
				...
				<!--/.panel-heading -->
				<div id="collapseReqs" class="panel-collapse <?php if (isset($activemenu) && $activemenu == 'credit_conversion_requests') echo 'collapse in';
																else echo 'collapse'; ?>">
					<div class="panel-body">
						<ul class="dashboard-links">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="panel-title">
					<a class="<?php if (isset($activemenu) && $activemenu == 'account') echo '';
								else echo 'collapsed'; ?>" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
						<i class="fa fa-user"></i><?php echo get_languageword('Account'); ?>
					</a>
				</h4>
			</div>
			<!--/.panel-heading -->
			<div id="collapseThree" class="panel-collapse <?php if (isset($activemenu) && $activemenu == 'account') echo 'collapse in';
															else echo 'collapse'; ?>">
				<div class="panel-body">
					<ul class="dashboard-links">
