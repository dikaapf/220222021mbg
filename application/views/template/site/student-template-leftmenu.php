<div class="panel-group dashboard-menu" id="accordion">
			...
			<div id="collapseOne" class="panel-collapse <?php if (isset($activemenu) && $activemenu == 'enquiries') echo 'collapse in';
				...
				<div class="panel-body">
					<ul class="dashboard-links">
						...
						<li <?php if (isset($activesubmenu) && $activesubmenu == get_languageword('Beri_Ulasan')) echo 'class="active"'; ?>><a href="<?php echo URL_STUDENT_ENQUIRIES; ?>/closed"><?php echo get_languageword('Beri_Ulasan'); ?> </a></li>
					</ul>
				</div>
				<!--/.panel-body -->
			</div>
	...
	<div id="collapseLeads" class="panel-collapse <?php if (isset($activemenu) && $activemenu == 'myleads') echo 'collapse in';
													else echo 'collapse'; ?>">
		<div class="panel-body">
			<ul class="dashboard-links">
			...
			<div class="panel-heading">
				<h4 class="panel-title">
					<a class="<?php if (isset($activemenu) && $activemenu == 'account') echo '';
								else echo 'collapsed'; ?>" data-toggle="collapse" data-parent="#accordion" href="#collapse-Account">
						<i class="fa fa-user"></i><?php echo get_languageword('Account'); ?>
					</a>
				</h4>
			</div>
			<!--/.panel-heading -->
			<div id="collapse-Account" class="panel-collapse <?php if (isset($activemenu) && $activemenu == 'account') echo 'collapse in';
																else echo 'collapse'; ?>">
				<div class="panel-body">
					<ul class="dashboard-links">
